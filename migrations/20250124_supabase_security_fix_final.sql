-- FINAL CORRECTED SECURITY DEPLOYMENT FOR TALENTPATRIOT ATS
-- Fixed foreign key constraint issue with demo user
...
-- ==========================================
-- PART 3: AUTO-CREATE USER PROFILES
-- ==========================================
...
-- ==========================================
-- PART 4: CREATE PROFILES FOR EXISTING USERS
-- ==========================================
...
-- Set demo user role if demo user exists in auth.users
-- Replace 'demo@yourapp.com' with your actual demo user email
UPDATE user_profiles 
SET role = 'demo_viewer' 
WHERE id IN (
...
-- SUCCESS MESSAGE
SELECT 'SECURITY FIXES DEPLOYED SUCCESSFULLY! All 11 errors should now be resolved.' as status;