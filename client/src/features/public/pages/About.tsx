  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <a href="/login">
                <Button className="bg-gray-700 hover:bg-gray-800 text-white font-medium text-sm md:text-base px-3 md:px-4 py-2 transition-colors">
                  Sign In
                </Button>
              </a>
              <a href="/onboarding/step1">
                <Button className="bg-blue-600 hover:bg-blue-700 text-white font-medium text-sm md:text-base px-4 md:px-6 py-2 whitespace-nowrap transition-colors">
                  Start Free
                </Button>
              </a>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <Card className="bg-white hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">Candidates Before Checkboxes</h3>
            ...
            <Card className="bg-white hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">Relationships Over Volume</h3>
                <p className="text-gray-600 leading-relaxed">
            ...
            <Card className="bg-white hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">Small Teams, Big Impact</h3>
                <p className="text-gray-600 leading-relaxed">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Who We're Built For</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <Card className="bg-gray-50 border-2 border-blue-200 hover:border-blue-400 transition-colors">
              <CardContent className="p-8">
                <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center mb-4">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-600">Hiring without enterprise complexity</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-blue-600 mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-600">Getting up and running in under an hour</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-blue-600 mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-600">Keeping hiring organized without a dedicated HR department</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gray-50 border-2 border-blue-200 hover:border-blue-400 transition-colors">
              <CardContent className="p-8">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Boutique Staffing & Recruiting Firms</h3>
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-blue-600 mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-600">Managing pipelines without fighting your ATS</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-blue-600 mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-600">Tracking relationships like a CRM—not a spreadsheet</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-blue-600 mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-600">Collaborating with clients and teammates effortlessly</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Why We Built TalentPatriot</h2>
            ...
            <div className="grid grid-cols-1 gap-4">
              <Card className="bg-white p-6 hover:shadow-lg transition-shadow">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 mb-1">Move Faster</h3>
                    <p className="text-sm text-gray-600">Speed matters in competitive hiring markets</p>
                  </div>
                </div>
              </Card>
              <Card className="bg-white p-6 hover:shadow-lg transition-shadow">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 mb-1">Stay Organized</h3>
                    <p className="text-sm text-gray-600">Keep every candidate and conversation tracked</p>
                  </div>
                </div>
              </Card>
              <Card className="bg-white p-6 hover:shadow-lg transition-shadow">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 mb-1">Win Top Talent</h3>
                    <p className="text-sm text-gray-600">Stop losing candidates to better systems</p>
                  </div>
                </div>
              </Card>
            </div>
      ...
      <section className="py-16 bg-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/onboarding/step1">
              <Button className="bg-white text-blue-600 hover:bg-gray-100 px-8 py-4 rounded-md font-medium text-base transition-colors w-full sm:w-auto">
                Start Free Trial
                <ArrowRight className="w-4 h-4 ml-2" />
              </Button>
            </a>
            <a href="/demo">
              <Button variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-blue-600 px-8 py-4 rounded-md font-medium text-base transition-colors w-full sm:w-auto">
                Request Demo
              </Button>
            </a>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-gray-900">TalentPatriot</h3>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="/help" className="text-gray-600 hover:text-blue-600 transition-colors">Support</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="/privacy" className="text-gray-600 hover:text-blue-600 transition-colors">Privacy</a></li>
                <li><a href="/terms" className="text-gray-600 hover:text-blue-600 transition-colors">Terms</a></li>
              </ul>
            </div>
          </div>
