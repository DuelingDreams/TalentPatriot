      ...
      <div className="w-full max-w-md">
        <Card className="bg-white">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-xl text-neutral-900">Access Denied</CardTitle>
            <CardDescription>
          ...
          <CardContent className="text-center space-y-4">
            <div className="text-sm text-neutral-600">
              <p>Your current role: <span className="font-medium text-neutral-900">{userRole || 'Unknown'}</span></p>
