        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12">
          ...
          <div className="mb-8 text-center">
            <div className="w-16 h-16 bg-tp-primary-light rounded-2xl flex items-center justify-center mx-auto mb-4">
              <Shield className="w-8 h-8 text-tp-primary" />
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="text-lg font-medium text-neutral-900 mb-2">Candidate Information</h3>
                <ul className="list-disc list-inside space-y-2 text-neutral-600">
          ...
          <section className="mb-10">
            ...
            <div className="bg-tp-card-surface rounded-xl p-6">
              <p className="text-neutral-900 font-medium mb-2">TalentPatriot Privacy Team</p>
              <p className="text-neutral-600">Email: privacy@talentpatriot.com</p>
