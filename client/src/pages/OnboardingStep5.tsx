    ...
    if (selectedGoal) {
      ...
      if (selectedAction) {
        const enhancedAction = {
          ...selectedAction,
          color: 'bg-gradient-to-br from-indigo-50 to-blue-50 hover:from-indigo-100 hover:to-blue-100 border-indigo-300 ring-2 ring-indigo-200',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        <div className="absolute top-32 right-20 w-16 h-16 bg-purple-500 rounded-full blur-xl" />
        <div className="absolute bottom-20 left-1/4 w-24 h-24 bg-green-500 rounded-full blur-xl" />
        <div className="absolute bottom-32 right-1/3 w-18 h-18 bg-yellow-500 rounded-full blur-xl" />
      </div>
      ...
      <div className="relative z-20 container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-talentpatriot-navy mb-4 tracking-tight">
            You're all set!
          </h1>
        ...
        {/* Quick Actions */}
        <div className="mb-12">
          <h2 className="text-2xl font-semibold text-center mb-2 text-talentpatriot-navy">
        ...
        <Card className="bg-white/80 backdrop-blur-sm border-2 border-gray-200">
          <CardContent className="p-8 text-center">
            <MessageCircle className="w-12 h-12 text-talentpatriot-softblue mx-auto mb-4" />
            
            <h3 className="text-xl font-semibold mb-3 text-talentpatriot-navy">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button className="bg-talentpatriot-navy hover:bg-talentpatriot-navy/90 text-white">
      ...
      <style dangerouslySetInnerHTML={{
        __html: `
          ...
          .confetti:nth-child(odd) {
            background: linear-gradient(45deg, #EF4444, #F97316, #84CC16, #06B6D4);
            border-radius: 50%;
          }
