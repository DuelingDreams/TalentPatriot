  ...
  return (
    <div className="min-h-screen bg-[#F7F9FC] font-[Inter,sans-serif]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <Card className="bg-white hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-bold text-[#1A1A1A] mb-3">Completely Free</h3>
            ...
            <Card className="bg-white hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-8 text-center">
                <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center mx-auto mb-4">
                  <MessageSquare className="w-6 h-6 text-[#264C99]" />
                </div>
                <h3 className="text-xl font-bold text-[#1A1A1A] mb-3">Direct Impact</h3>
                <p className="text-[#5C667B] leading-relaxed">
            ...
            <Card className="bg-white hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-bold text-[#1A1A1A] mb-3">Exclusive Access</h3>
                <p className="text-[#5C667B] leading-relaxed">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-12">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#1A1A1A] mb-4">Apply for Beta Access</h2>
            <p className="text-lg text-[#5C667B] max-w-2xl mx-auto">
            ...
            <CardContent>
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-lg font-semibold flex items-center gap-2">
                      <Target className="w-5 h-5 text-[#264C99]" />
                      Current State & Goals
                    </h3>
                  ...
                  <div className="flex justify-end pt-4">
                    <Button 
                      ...
                      className="bg-[#1F3A5F] hover:bg-[#264C99] px-8 py-3"
                    >
      ...
      <section className="py-16 bg-[#F7F9FC]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#1A1A1A] mb-4">What Happens Next?</h2>
            <p className="text-lg text-[#5C667B] max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-12 h-12 bg-[#E6F2FF] rounded-xl flex items-center justify-center mx-auto mb-4">
                <span className="text-xl font-bold text-[#264C99]">1</span>
              </div>
              <h3 className="text-lg font-bold text-[#1A1A1A] mb-2">Review & Approval</h3>
            ...
            <div className="text-center">
              <div className="w-12 h-12 bg-[#E6F2FF] rounded-xl flex items-center justify-center mx-auto mb-4">
                <span className="text-xl font-bold text-[#264C99]">2</span>
              </div>
              <h3 className="text-lg font-bold text-[#1A1A1A] mb-2">Onboarding Call</h3>
              <p className="text-[#5C667B]">
            ...
            <div className="text-center">
              <div className="w-12 h-12 bg-[#E6F2FF] rounded-xl flex items-center justify-center mx-auto mb-4">
                <span className="text-xl font-bold text-[#264C99]">3</span>
              </div>
              <h3 className="text-lg font-bold text-[#1A1A1A] mb-2">Start Recruiting</h3>
              <p className="text-[#5C667B]">
