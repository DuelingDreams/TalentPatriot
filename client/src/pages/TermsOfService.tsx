        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12">
          ...
          <section className="mb-10">
            <div className="flex items-center gap-3 mb-4">
              <Scale className="w-6 h-6 text-[#264C99]" />
              <h2 className="text-2xl font-semibold text-[#1A1A1A]">1. Acceptance of Terms</h2>
            </div>
          ...
          {/* Service Description */}
          <section className="mb-10">
            <h2 className="text-2xl font-semibold text-[#1A1A1A] mb-4">2. Service Description</h2>
          ...
          <section className="mb-10">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-semibold text-[#1A1A1A]">3. Account Registration and Security</h2>
            </div>
            
            <div className="space-y-4 text-[#5C667B]">
          ...
          <section className="mb-10">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-semibold text-[#1A1A1A]">4. Acceptable Use Policy</h2>
            </div>
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-semibold text-[#1A1A1A] mb-4">5. Intellectual Property Rights</h2>
            
            <div className="space-y-4 text-[#5C667B]">
              <div>
                <h3 className="text-lg font-medium text-[#1A1A1A] mb-2">Our Intellectual Property</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-medium text-[#1A1A1A] mb-2">Your Content</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-medium text-[#1A1A1A] mb-2">Feedback</h3>
                <p>
          ...
          {/* Payment Terms */}
          <section className="mb-10">
            <h2 className="text-2xl font-semibold text-[#1A1A1A] mb-4">6. Payment Terms</h2>
          ...
          <section className="mb-10">
            <div className="flex items-center gap-3 mb-4">
              <Ban className="w-6 h-6 text-[#264C99]" />
              <h2 className="text-2xl font-semibold text-[#1A1A1A]">7. Termination</h2>
            </div>
          ...
          <section className="mb-10">
            <div className="flex items-center gap-3 mb-4">
              <AlertCircle className="w-6 h-6 text-[#264C99]" />
              <h2 className="text-2xl font-semibold text-[#1A1A1A]">8. Disclaimers and Limitations</h2>
            </div>
          ...
          {/* Indemnification */}
          <section className="mb-10">
            <h2 className="text-2xl font-semibold text-[#1A1A1A] mb-4">9. Indemnification</h2>
          ...
          {/* Governing Law */}
          <section className="mb-10">
            <h2 className="text-2xl font-semibold text-[#1A1A1A] mb-4">10. Governing Law and Disputes</h2>
          ...
          <section className="mb-10">
            <div className="flex items-center gap-3 mb-4">
              <RefreshCw className="w-6 h-6 text-[#264C99]" />
              <h2 className="text-2xl font-semibold text-[#1A1A1A]">11. Changes to Terms</h2>
            </div>
          ...
          {/* Contact Information */}
          <section>
            <h2 className="text-2xl font-semibold text-[#1A1A1A] mb-4">12. Contact Information</h2>
            ...
            <div className="bg-[#F0F4F8] rounded-xl p-6">
              <p className="text-[#1A1A1A] font-medium mb-2">TalentPatriot Legal Team</p>
              <p className="text-[#5C667B]">Email: legal@talentpatriot.com</p>
