...
# Security Contact: security@talentpatriot.com`);
  ...
  app.get("/api/offer-letters", requireAuth, async (req: AuthenticatedRequest, res) => {
    try {
  ...
  app.get("/api/offer-letters/by-job/:jobId", requireAuth, async (req: AuthenticatedRequest, res) => {
    try {
      const orgId = await getAuthOrgId(req);
  ...
  app.get("/api/offer-letters/by-candidate/:candidateId", requireAuth, async (req: AuthenticatedRequest, res) => {
    try {
      const orgId = await getAuthOrgId(req);
      if (!orgId) return res.status(400).json({ error: "Organization ID required" });
  ...
  app.get("/api/offer-letters/by-client/:clientId", requireAuth, async (req: AuthenticatedRequest, res) => {
    try {
      const orgId = await getAuthOrgId(req);
      if (!orgId) return res.status(400).json({ error: "Organization ID required" });
  ...
  app.get("/api/offer-letters/accepted", requireAuth, async (req: AuthenticatedRequest, res) => {
    try {
      const orgId = await getAuthOrgId(req);
      if (!orgId) return res.status(400).json({ error: "Organization ID required" });
  ...
  app.get("/api/offer-letters/:id", requireAuth, async (req: AuthenticatedRequest, res) => {
    try {
      const orgId = await getAuthOrgId(req);
      if (!orgId) return res.status(400).json({ error: "Organization ID required" });
  ...
  app.post("/api/offer-letters", requireAuth, writeLimiter, async (req: AuthenticatedRequest, res) => {
    try {
      const orgId = await getAuthOrgId(req);
      if (!orgId) return res.status(400).json({ error: "Organization ID required" });
  ...
  app.put("/api/offer-letters/:id", requireAuth, writeLimiter, async (req: AuthenticatedRequest, res) => {
    try {
      const orgId = await getAuthOrgId(req);
      if (!orgId) return res.status(400).json({ error: "Organization ID required" });
  ...
  app.delete("/api/offer-letters/:id", requireAuth, writeLimiter, async (req: AuthenticatedRequest, res) => {
    try {
      const orgId = await getAuthOrgId(req);
      if (!orgId) return res.status(400).json({ error: "Organization ID required" });
      const existing = await storage.offerLetters.getOfferLetter(req.params.id);
  ...
  app.get("/api/clients/stats/financials", requireAuth, async (req: AuthenticatedRequest, res) => {
    try {
      const orgId = await getAuthOrgId(req);
      if (!orgId) return res.status(400).json({ error: "Organization ID required" });
