-- AI Insights Enhancement SQL Script (FINAL VERSION)
-- First, fix the organization_role enum to include missing values

-- Add missing enum values to organization_role
...
-- Now create the AI insights tables with corrected role references
